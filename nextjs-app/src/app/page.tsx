    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-center sm:text-left">
          Bienvenido a tu sitio con Next.js
        </h1>
        <p className="text-balance text-center sm:text-left text-sm/6">
          Empieza editando
          {" "}
          <code className="bg-black/[.05] dark:bg-white/[.06] font-mono font-semibold px-1 py-0.5 rounded">
            src/app/page.tsx
          </code>
          . Guarda y verás los cambios al instante.
        </p>
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        <a
          ...
          rel="noopener noreferrer"
        >
          <Image aria-hidden src="/file.svg" alt="Icono de archivo" width={16} height={16} />
          Aprender
        </a>
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <Image aria-hidden src="/globe.svg" alt="Icono de globo" width={16} height={16} />
          Ir a nextjs.org →
        </a>
      </footer>
    </div>
